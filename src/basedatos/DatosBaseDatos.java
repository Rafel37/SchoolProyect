...
public interface DatosBaseDatos {
    ...
    public static String TAB_INICIO_COL_PASS           = "PASS";
    public static String TAB_CICLOS_COL_CICLO          = "CICLO";
    public static String TAB_CICLOS_COL_CONOCIMIENTO   = "CONOCIMIENTO";
